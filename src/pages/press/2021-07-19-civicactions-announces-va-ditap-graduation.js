        ...
        <RedLayout>
            ...
            <div className='single--press-releases--main'>
                <div className='inner'>
                    ...
                    <p className='body'>CivicActions is pleased to announce the graduation of its newest <a href='https://civicactions.com/ditap'>Digital IT Acquistion Professional (DITAP)</a> cohort, which included 24 procurement officers from the Department of Veteran Affairs.</p>

    ...
    return (
        <RedLayout>
            ...
            <div className='single--press-releases--main'>
                <div className='inner'>
                    <div className='body'>
                        <span>Date: Monday, July 19, 2021</span>
                        <p>CivicActions is pleased to announce the graduation of its newest <a href='https://civicactions.com/services/ditap'>Digital IT Acquisition Professional (DITAP)</a> cohort, which included 24 procurement officers from the Department of Veteran Affairs.</p>
                        ...
                        <p>The six-month program starts by covering 21st century digital services — including agile software development, human-centered design, cloud computing and data management. Students then learn how to contract these services, and ensure their projects are successful.</p>
                        ...
                        <p>With this cohort, CivicActions is pleased to congratulate the following DITAP graduates:</p>
                        <p><ul>

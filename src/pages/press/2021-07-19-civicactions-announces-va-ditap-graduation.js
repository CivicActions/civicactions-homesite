        ...
        <RedLayout>
            ...
            <div className='single--press-releases--main'>
                <div className='inner'>
                    ...
                    <p className='body'>CivicActions is happy to announce the graduation of its newest <a href='https://civicactions.com/services/ditap'>Digital IT Acquisition Professional (DITAP)</a> cohort, which included 24 procurement officers from the Department of Veteran Affairs.</p>

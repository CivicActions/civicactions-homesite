    ...
    <RedLayout>
      ...
      <section className='careers--hero-section hero-component'>
        <div className='inner'>
          ...
          <p className='body'>Join our team of talented and open-minded people working to build modern and accessible government services for all.</p>
          <LinkButton src='/careers#open-positions' text='See all open positions' />
        </div>
      </section>

      <Video videolink='https://player.vimeo.com/video/310174855' videotitle='Why join Civicactions video' videotext='CivicActions is a place to learn and grow with others who are passionate about putting people first. Learn how our multi-disciplinary teams use technology and design to bring government services up to today’s standards.' />
        ...
        <div className='inner'>
          ...
          <div className='what-we-look-for'>
            ...
            <div className='right-aligned'>
              ...
              <img className='icon' src={squareCircle} alt='' />
              <p className='body'>Hiring smart and friendly people is the most important thing we do for ourselves and our clients. We look for folks with high emotional intelligence and strong communication skills. We also believe that your willingness to learn and grow is as valuable as your existing skill set. We seek self-motivated, curious people who want to make a difference.</p>
              <p className='body'>
      ...
      <section className='careers--offerings-section'>
        <div className='inner'>
          <h2>What we offer</h2>
          <p className='body'>We believe people do their best work when they can be balanced, healthy, and happy. Our work environment is designed to support your personal and professional growth.</p>
      ...
      <StaffQuote img={michelleKangProfilePicture} quote='“I appreciate the kindness of people at CivicActions, no matter the role or position. We really take care of each other.”' name='Michelle Kang' role='Product Designer' classes='first-quote' />

      <section className='careers--open-positions-section'>
        <div className='inner'>
          <h2 id='open-positions'>Open positions</h2>
          <p className='body'>We actively seek to broaden the diversity of our team, and strongly encourage people from underrepresented groups to apply.</p>
          <div className='jobs-grid'>
            {!job.length && (
              <div className='no-job'>
                <p className='body'>No positions are currently open. Please check back again soon!</p>
              </div>
            )}
            {job.map(({ node }, index) => (
      ...
      <section className='careers--application-process-section'>
        <div className='inner'>
          ...
          <p className='body'>Here’s what to expect from our hiring process. We do our best to respect your time as we explore the possibility of adding you to our high-caliber team. Check out our tips on creating a noteworthy application.</p>
          <div className='steps-grid'>
            <div className='step'>
              <span className='h2'>1</span>
              <h3 className='h5'>Application Review</h3>
              <p className='body'>Your application is reviewed by our hiring team and the folks who will be working with you.</p>
            </div>
            <div className='step'>
              <span className='h2'>2</span>
              <h3 className='h5'>Workstyle Interview</h3>
              <p className='body'>The first interview helps us learn how you collaborate, problem-solve, and work as a team player.</p>
            </div>
            <div className='step'>
              <span className='h2'>3</span>
              <h3 className='h5'>Skills-based Interview</h3>
              <p className='body'>This interview evaluates your qualifications for the specific role (technical, design, etc.)</p>
            </div>
            <div className='step'>
              <span className='h2'>4</span>
              <h3 className='h5'>Deeper Dive</h3>
              <p className='body'>You may be asked to do a take-home assignment, simulation, challenge, or interview with a client.</p>
            </div>
          </div>
          <p className='h5'>If all goes well, we will answer any questions you may have and welcome you to the CivicActions family!</p>
        </div>
      </section>
      <section className='home--learn-w-us-section'>
        ...
        <div className='inner'>
          ...
          <div className='cases'>
            <PressReleaseTeaser img={caseStudyTeaserImg6} teaserlink='https://medium.com/civicactions/quickly-shifting-to-distributed-teams-in-government-54bd79b912c3' title='Quickly shifting to distributed teams in government' description='Best practices for agency teams transitioning to telework' />
            <PressReleaseTeaser img={caseStudyTeaserImg7} teaserlink='https://medium.com/civicactions/improving-scrum-team-flow-on-digital-service-projects-6723d95eaad8' title='Improving scrum team flow on digital service projects' description='The 30-second ritual that helps us work better together' />
      ...
      <StaffQuote image={irisIbekweProfilePicture} quote='“I love the honest, collaborative atmosphere, and the way CivicActions prioritizes the well-being of team members.”' name='Iris Ibekwe' role='Engineer' classes='second-quote' />
      <PrimaryPageCTA title='Help us build the future.' subtitle='Let’s create better government services together.' primaryButtonText='See open positions' secondaryButtonText='Meet our team' />
    </RedLayout>
  );
};

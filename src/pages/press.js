...
const Press = () => {
  return (
    <RedLayout>
      <SEO title='Press' />
      <Hero title='This work is worth talking about.' description='When government invests in smart technology and thoughtful design of services, millions of people stand to benefit for years to come. We are honored to be part of this work.' />
      <section className='temp-press-releases--main-section'>
        <div className='inner'>
          <div className='press-release--items'>
            ...
            <p className='body'>
              Full story: <Link to='/press/2021-05-11-civicactions-wins-department-of-ed-recompete'>Department of Education Awards CivicActions 5-Year Contract to Advance Adult Literacy</Link>
            </p>
          </div>
          <div className='press-release--items'>
            ...
            <p className='body'>
              Full story: <Link to='/press/2021-05-03-civicactions-wins-nsf-recompete'>NSF Awards CivicActions $44M Contract for CMS Support and Improvement of Federal Science Research Website</Link>
            </p>
          </div>
          <div className='press-release--items'>
            ...
            <p className='body'>
              Full story: <a href='https://gcn.com/articles/2021/02/04/accessibility-compliance-as-code.aspx'>ATO ASAP: Streamlining government security with a Federal Compliance Library</a>
            </p>
          </div>
          <div className='press-release--items'>
            ...
            <p className='body'>
              Full story: <a href='https://fcw.com/articles/2021/02/04/comment-lazzeri-automate-ato.aspx'>ATO ASAP: Let’s finally fix the security compliance problem</a>
            </p>
          </div>
          <div className='press-release--items'>
            ...
            <p className='body'>
              Full story: <a href='https://www.govtech.com/100/2021/'>2021 GovTech 100 List</a>
            </p>
          </div>
          <div className='press-release--items'>
            ...
            <p className='body'>
              Full story: <Link to='/press/2020-11-09-civicactions-acquires-openconcept'>CivicActions Expands Accessibility Capabilities With OpenConcept</Link>
            </p>
          </div>
          <div className='press-release--items'>
            ...
            <p className='body'>
              Full story: <Link to='/press/2020-08-14-civicactions-certified-to-deliver-ditap'>CivicActions Certified to Deliver DITAP Procurement Training to Federal Acquisition Professionals</Link>
            </p>
          </div>
          <div className='press-release--items'>
            ...
            <p className='body'>
              Full story: <Link to='/press/2020-03-02-civicactions-wins-cms-contract'>CivicActions Wins $18M Contract to Migrate, Redesign CMS Websites</Link>
            </p>
          </div>
        </div>
      </section>
      <PrimaryPageCTA title='Inspired by newsworthy work?' subtitle='See what we can do together.' primaryButtonText='EXPLORE SERVICES' secondaryButtonText='CONTRACTING INFO' />
    </RedLayout>
  );
};

...
const LicensingPage = () => {
  return (
    <GeneralLayout>
      ...
      <section className="licensing__quote-section">
        <div className="inner">
          <img src={henryPooleProfilePicture} alt="" className="picture"></img>
          <div className="quote">
            <h4>
              “We have never strayed from our commitment to ‘open by default’
              and ‘people first.’”
            </h4>
            <div className="body">Henry Poole</div>
            <div className="body">CivicActions co-founder and CEO</div>
          </div>

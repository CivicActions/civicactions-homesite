                ...
                <div className='inner'>
                  ...
                  <div className='contact-grid'>
                        <div className='grid'>
                            ...
                            <a style={fontStyles} href="mailto:contact@civicactions.com" className='link body'>contact@civicactions.com</a>
                        </div>
                      <div className='grid'>
                          <img src={mailIcon} alt='mail icon'></img>
                          <p style={fontStyles} className='label body'>MAIL</p>
                          <a style={fontStyles} href="https://www.google.com/maps/place/3527+Mt+Diablo+Blvd+%23269,+Lafayette,+CA+94549,+USA/data=!4m2!3m1!1s0x8085625abdbe2b5d:0x1ab127226da2131c?sa=X&ved=2ahUKEwjvoPTJ7cTwAhVGT6wKHRJAAssQ8gEwAHoECAUQAQ" className='link body'>3527 Mt Diablo Blvd #269 Lafayette, CA 94549</a>
                      </div>
                      <div className='grid'>
                          <img src={phoneIcon} alt='phone icon'></img>
                          <p style={fontStyles} className='label body'>PHONE</p>
                          <a style={fontStyles} href="tel:510-408-7510" className='link body'>(510) 408-7510</a>
                      </div>
                  </div>
                </div>
              </section>
